...
; Definições dos Registradores especiais do PORT J
...
GPIO_PORTJ               	EQU		2_000000100000000	;pg 382 datasheet
...
GPIO_PORTF               	EQU		2_000000000100000	;pg 382 datasheet
; Definições dos Registradores especiais do PORT N
...
PortF_Output
	...
	LDR 	R3, [R1]						;Carrega o valor do PORTF(leitura) em R2;
	BIC 	R3, #2_00010001                 ;Primeiro limpamos os dois bits do lido da porta R2 = R2 & 11101110
	ORR 	R8, R8, R3                      ;Fazer o OR do lido pela porta com o parâmetro de entrada
	STR 	R8, [R1]                        ;Escreve na porta F o barramento de dados dos pinos F4 e F0
	BX 		LR								;Retorna da Chamada da Função
;################################################################################
; Função PortN_Output
...
PortN_Output
	...
	;Read-Modify-Write para escrita
;	LDR R3, [R1]
;	BIC R3, #2_00000010                     	;Primeiro limpamos os dois bits do lido da porta R2 = R2 & 11111101
;	ORR R7, R7, R3                          	;Fazer o OR do lido pela porta com o parâmetro de entrada
	STR R7, [R1]                            	;Escreve na porta N o barramento de dados do pino N1
	BX LR										;Retorno
...
PortJ_Input
	...
	LDR 	R2, [R1]                        ;Lê no barramento de dados dos pinos [J1-J0]
	BX 		LR								;Retorno
